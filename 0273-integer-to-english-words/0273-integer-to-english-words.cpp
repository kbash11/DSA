...
public:
    unordered_map<int,string> belowTen ={{0,""},{1,"One"},{2,"Two"},{3,"Three"},{4,"Four"},{5,"Five"},{6,"Six"},{7,"Seven"},{8,"Eight"},{9,"Nine"}};
        ...
        unordered_map<int,string> belowHund={{1,"One"},{2,"Twenty"},{3,"Thirty"},{4,"Forty"},{5,"Fifty"},{6,"Sixty"},{7,"Seventy"},{8,"Eighty"},{9,"Ninety"}};
    string solve(int n){
        if(n<10){
            return belowTen[n];
        }
        ...
        if(n<100){
            return belowHund[n/10] + ((n%10) ? " " + belowTen[n%10] : "");
        }
        if(n<1000){
